...
export const hairstyleOptions: HairstyleOption[] = [
  ...
  },
  {
    ...
    prompt: 'Apply a medium-to-long hairstyle with soft curtain bangs. The bangs have a clear center part and wispily open away from the forehead, gently framing the eyes and cheekbones. The rest of the hair features soft flattering layers with a natural polished look, emphasizing feminine softness.',
  },
  {
    ...
    prompt: 'Apply a classic blunt bob hairstyle cut exactly at chin level with a perfectly straight heavy perimeter line. The shape is symmetrical, sleek, and geometric, with smooth glossy hair. No visible layers or waves. The bob perfectly frames the face on both sides, looking timeless and tailored.',
  },
  {
  ...
  },
  {
    ...
    prompt: 'Apply a fluffy short bob hairstyle with a rounded silhouette ending between the ear and jawline. The hair has soft airy volume, looking full, bouncy, and youthful around the cheeks. The outline is rounded with light movement and a fresh Korean salon finish, appearing delightfully plush.',
  },
  {
    ...
    prompt: 'Apply a beautiful medium length hairstyle featuring see-through bangs. The bangs are very thin and wispy, lightly covering the forehead while still letting the skin show through. The fringe is soft, airy, and delicate with slight center separation. The rest of the hair is smooth and feminine.',
  },
  {
    id: 'female-bun-messy',
    ...
    prompt: 'Apply a messy high bun hairstyle with the hair gathered at the top of the head into a loose, relaxed top knot. The bun looks intentionally effortless, with soft flyaway pieces and wispy face-framing strands around the temples and cheeks. The impression is casual, chic, and naturally pretty.',
  },
];
